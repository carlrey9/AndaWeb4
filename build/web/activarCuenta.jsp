<%-- 
    ...
    Created on : 12/12/2017, 11:53:02 AM
    Author     : hubio
--%>

<%@page import="com.hubionics.anda.web.controller.VerificarCorreoController"%>
    ...
    <body>
        <div class="container body-colordark">
            ...
            <div style="min-height: 300px">
                ...
                <%
                    VerificarCorreoController verificarCorreoController = new VerificarCorreoController();

                    int valueReturn = verificarCorreoController.verificarCorreo(request.getParameter("t"));
                    switch (valueReturn) {
                        case 0:
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            out.print("<p class=\"bg-success tamano-info\">Correo ya fue Verificado, ya puedes ingresar a la aplicación.</p>");
                            break;
                        case 3:
                            out.print("<p class=\"bg-success tamano-info\">Correo Verificado, ya puedes ingresar a la aplicación.</p>");
                            break;
                        default:
