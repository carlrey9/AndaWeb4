...
public class AdminDbManager {
    ...
    public Respuesta enviarMailPrueba() {
        ...
        try {
             ...
             * "<img src=\"http://www.humansbionics.co.uk:55411/AndaWeb4/resources/img/headcorreo.png\"/>"
             * + "<br/><br/><h1>Bienvenido a ANDA</h1>"
             * + "<br/><br/><h2> Gracias por registrarte.</h2>"
             * + "<br/><br/> Sigue este link para activar tu cuenta:"
             * +
             * "<br/> <a href=\"http://www.humansbionics.co.uk:55411/AndaWeb4/activarCuenta.jsp?t="
             * + tokenCorreo +
             * "\">http://www.humansbionics.co.uk:55411/AndaWeb4/activarCuenta.jsp?t=" +
             * tokenCorreo + "</a>"
             * +
             * "<br/><br/> Si no puedes visitar el link copia y pega este texto en el navegador."
             * +
             * "<br/>http://www.humansbionics.co.uk:55411/AndaWeb4/api/v1/activarCuenta.jsp?t="
             * + tokenCorreo + ""
             * +
             * "<br/><br/><img src=\"http://www.humansbionics.co.uk:55411/AndaWeb4/resources/img/piefirmacorreo.png\"/>"
             * ;
            ...
            /*
             * String FILENAME =
             * "/opt/glassfish4/glassfish/domains/domain1/config/logs/error4.txt";
